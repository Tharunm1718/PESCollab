...
const NavIcon = ({ title, children, onClick }) => (
  <div className="nav-icon" title={title} onClick={onClick}>
    {children}
  </div>
);
function Sidebar() {
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-rails-container">
          ...
          <div className="glass-card sidebar-rail">
            <NavIcon title="Home" onClick={() => navigate('/dashboard')}>
            ...
            <NavIcon title="Projects" onClick={() => navigate('/yourprojects')}>
            ...
            <NavIcon title="Teams" onClick={() => navigate('')}>
            ...
            <NavIcon title="Community" onClick={() => navigate('/community')}>
              <Network size={32} />
            </NavIcon>
          </div>
          ...
          <div className="glass-card sidebar-rail">
            ...
            <NavIcon title="Settings" onClick={() => navigate('/settings')}>
                <Settings size={32} />
            </NavIcon>
          </div>
        </div>
